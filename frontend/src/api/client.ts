...
export interface BackupRecord { id: string; profile_id: string; status: "in_progress" | "completed" | "failed"; method: "world_archive"; trigger: "manual" | "schedule"; file_name: string | null; size_bytes: number | null; duration_ms: number | null; result: string; created_at: string; completed_at: string | null }
